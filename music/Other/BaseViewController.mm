...
- (void)enableOpenLeftDrawer:(BOOL)enable
{
    if (enable == YES) {
        // 能够打开
        UINavigationController *leftNav = [[UINavigationController alloc] initWithRootViewController:[[SettingVC alloc] init]];
...
//        UINavigationController *RightNav = [[UINavigationController alloc] initWithRootViewController:[[RightViewController alloc] init]];
        LRCViewController *rightVC = [[LRCViewController alloc] init];
