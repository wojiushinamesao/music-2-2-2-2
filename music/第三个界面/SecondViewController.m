...
{
    _page ++;
    [ReloadDataModel getData:[NSString stringWithFormat:@"http://wangyi.butterfly.mopaasapp.com/news/api?type=tech&page=%ld&limit=15",(long)_page] successBlock:^(id posts) {
...
- (void)fillData
{
    ...
    [ReloadDataModel getData:@"http://wangyi.butterfly.mopaasapp.com/news/api?type=tech&page=1&limit=15" successBlock:^(id posts) {
        NSDictionary * dic = (NSDictionary *)posts;
        NSArray * listArr = dic[@"list"];
        [_dataArr addObjectsFromArray:listArr];
        [_tableView reloadData];
